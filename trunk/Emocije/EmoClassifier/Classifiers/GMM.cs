...
{
    public class GMM:AbstractClassifier
    {
        public override event AbstractClassifier.ClassifComplete ClassificationComplete;

        double[,] mu = new double[11, 5] {
        {0.0000,0.0001,0.0004,0.0000,0.0011},
        {0.0000,0.0000, 0.0000,0.0000,0.0001},
        {0.0013, 0.0006, 0.0008, 0.0011,0.0005},
        {0.0003,0.0010,0.0004,0.0001,0.0021},
        {-0.0000,-0.0000,0.0000,-0.0000,0.0001},
        {0.0002, 0.0002,0.0002 ,0.0002 ,0.0001},
        { 0.0000,0.0000,0.0000,0.0000,0.0000},
        { 0.0145,0.0285,0.0326,0.0064,0.0393},
        { 1.3798,0.6362,3.2903,3.6128 ,0.2600},
        { 0.0065,0.0119,0.0134,0.0030,0.0155},
        {0.0000,0.0000,0.0000,0.0000,0.0000}};

        

        public static double[,] sigma0 =  {{ 76.449905, 2.288436, -3.813529, 13.418779, 29.629162, -0.858317, 0.000443, -87.129828, -1535.117882, -53.268922, 0.003419 }, { 2.288436, 0.267097, -0.487026, 1.293760, 0.904129, -0.110081, -0.000008, -2.186024, -548.363562, -3.509738, -0.000323}, 
         ...
         public static double[,] sigma1     = {{0.078347,0.000128,0.023609,0.044950,0.019726,0.003981,-0.000016,-0.748214,-496.298340,-0.580347,-0.000449},{0.000128,0.000176,-0.014377,0.005688,-0.000252,-0.003142,-0.000000,0.188282,-24.790024,0.070444,0.000007},
         ...
         public static double[,] sigma2 =  {{10.390918,-0.058070,-0.197155,0.684840,3.805180,0.141330,-0.000453,-65.333715,-24306.473920,-24.143684,-0.014722},{-0.058070,0.008328,-0.152344,-0.000224,-0.028213,-0.028493,0.000046,2.434261,1372.943599,1.275106,0.001686},
         ...
         public static double[,] sigma3= {{0.000039,0.000004,-0.009617,0.000282,-0.000029,-0.000705,0.000001,-0.007562,-29.755387,-0.004853,0.000008},{0.000004,0.000003,-0.002870,0.000166,-0.000002,-0.000461,0.000000,-0.001781,-11.925859,-0.000669,-0.000000},
         ...
         public static double[,] sigma4= {{0.000039,0.000019,-0.016979,-0.000160,0.000262,-0.001650,-0.000001,-0.041291,117.404250,-0.013412,0.000009},{0.000019,0.000018,-0.011291,0.000836,0.000140,-0.001131,-0.000000,0.043054,27.468333,0.018847,0.000008},
        ...
        private int[] indices = { 0 ,3,5,1,2,8,9,10,4,6,7}; 
        ...
        {
            get { return "Gaussian Mixture Model"; }
        }
    }
}
